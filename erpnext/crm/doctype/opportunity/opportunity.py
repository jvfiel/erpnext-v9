...
def make_customer(source_name, target_doc=None):
	print "HELLO CUSTOMER", source_name
	def set_missing_values(source, target):
		...
		"""
                ...
                cur_frm.set_value("customer_name",opp_lead_name);
        cur_frm.set_value("opportunity_name",opp_lead_name);
        cur_frm.set_value("record_owner",opp_lead_owner);
        cur_frm.set_value("lead_reference",opp_lead_from);

        opp_lead_owner = cur_frm.doc.lead_owner;
                    opp_lead_name = cur_frm.doc.lead_name;
                    opp_lead_from = cur_frm.doc.name;
		...
		print source.lead
		print source.name
		lead_doc = frappe.get_doc("Lead",source.lead)
		target.geolocation = lead_doc.geolocation
		target.lead_name = source.lead
